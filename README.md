...
- :calendar: 16/07/2022 saturday -[x] String InBuilt Functions
  - [x] upper() method
  - [x] lower() method
  - [x] title() method
  - [x] capitalize() method
...
* [x] tkinter module
  - [x] Working With Widgets - [x] Treeview widgets - [x] Toplevel widget - [x] file dialogs - [x] MessageBox Widget
        \*:bookmark_tabs: The Courses and website where I learn about this topic's.\*\*
